...
//            binding.textExerciseTitle.text = exercise.name
//            binding.textExerciseDetails.text = "Body Part: ${exercise.bodyPart}\nTarget: ${exercise.target}\nEquipment: ${exercise.equipment}"
//            binding.imageExercise.setImageURI(Uri.parse(exercise.gifUrl))
//
//            // Ensure details are initially collapsed
//            binding.exerciseDetailsContainer.visibility = View.GONE
//            binding.expandCollapseButton.text = "Expand"
//        }
//
//        private fun toggleDetailsVisibility() {
//            if (binding.exerciseDetailsContainer.visibility == View.GONE) {
//                binding.exerciseDetailsContainer.visibility = View.VISIBLE
//                binding.expandCollapseButton.text = "Collapse"
//            } else {
//                binding.exerciseDetailsContainer.visibility = View.GONE
//                binding.expandCollapseButton.text = "Expand"
